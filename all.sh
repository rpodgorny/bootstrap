...
wget --no-check-certificate http://rawgit.com/rpodgorny/bootstrap/master/4_incoming_setup.sh
...
rm -f openvpn.sh
wget --no-check-certificate http://rawgit.com/rpodgorny/bootstrap/master/openvpn.sh
chmod a+x openvpn.sh
./openvpn.sh
rm openvpn.sh

rm -f other.sh
wget --no-check-certificate http://rawgit.com/rpodgorny/bootstrap/master/other.sh
chmod a+x other.sh
./other.sh
rm other.sh

rm -f atx300.sh
wget --no-check-certificate http://rawgit.com/rpodgorny/bootstrap/master/atx300.sh
chmod a+x atx300.sh
./atx300.sh
rm atx300.sh
